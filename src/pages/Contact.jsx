...
const Contact = () => {
    ...
    return (
        ...
        <div className='bg-white'>
            ...
            {/* Address Section */}
            <section className=" overflow-hidden shadow-xl rounded-lg flex flex-col w-[90vw] md:w-1/2 mt-16 mx-auto" data-aos="zoom-in-up">
            ...
            <section className="bg-white py-16 shadow-xl" >
                <div className="container mx-auto px-4 sm:px-6 lg:px-8" data-aos="zoom-in-up">
